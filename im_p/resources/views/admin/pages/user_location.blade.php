                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($users_info as $info)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('user-location-edit'.'/'.$info->id)}}" class="btn blue btn-outline"><i class="fa fa-edit"></i></a>
                                        <button class="btn blue btn-danger"  href="{{url('delete-user-location'.'/'.$info->id)}}" data-toggle="confirmation" data-original-title="Are you sure ?"
