                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-user"></i> Edit User Location Report</div>
                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <div ng-app="emp_leave" ng-controller="form-validation">
                             <form name="employee-leave"   action="{{url('user-location-update'.'/'.$info->id)}}" class="form-horizontal" method="post" >
                             {{csrf_field()}}
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="form-group  {{$errors->has('form_title') ? 'has-error' : ''}}">
                                           ...
                                           <input type="text" name="form_title" class="form-control" placeholder="write form title" value="{{old('form_title') ? old('form_title') :$info->form_title}}">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea class="form-control" name="note_of_location" placeholder="note about form">{{old('note_of_location') ? old('note_of_location') : $info->note_of_location}}</textarea>  
                                        </div>
                                    </div>
                                </div>
                                </div>
